...
import { faqContainerVariants, faqItemVariants } from "@/lib/animations";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div variants={faqItemVariants} className="text-center space-y-2 sm:space-y-3">
        ...
        <motion.div variants={faqItemVariants} className="w-full transform-gpu">
